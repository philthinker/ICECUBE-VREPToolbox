function [ joints ] = ur5MoveToPositionPro( icecube, targetPosition )
%ur5MoveToPositionPro Reflexxes Motion Library - Move by ik group - position
%while read the joint & Caresian positions.
% icecube: the icecube object
% targetPosition: 1 x 3 covector, the target xyz position
% joints: M x 6, the route joint positions
% If you DO NOT need route joint positions, use 'ur5MoveToPosition.m'
