function [ res, rg2Velocity ] = simx_rg2Close( vrep, clientID, simx_opmode )
%simx_rg2CLose close your RG2 gripper
...
[res, retInts, retFloats, retStrings, retBuffer] = vrep.simxCallScriptFunction(clientID, 'RG2',...
    vrep.sim_scripttype_childscript,'rg2Close',[],[],[],[],simx_opmode);
